...
class MyLoggerHandler(logging.FileHandler):
    def __init__(self, filename, basedir, when='D', backupCount=0, encoding=None, delay=False):
        ...
        self.filefmt = os.path.join(basedir, "logs", "%s.%s.log" % (self.prefix, self.suffix))
